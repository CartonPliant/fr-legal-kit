...
const ROUTES = {
  ...
  "/v1/phone-fr": {
    ...
    tags: ["france", "phone", "invoice", "e164", "arcep"],
    bazaar: {
      info: {
        input: { type: "http", method: "POST", body: { phone: "06 12 34 56 78" } },
        output: { type: "json", example: { ok: true, e164: "+33612345678", kind: "mobile" } },
      },
    },
    fn: phoneFr,
  },
